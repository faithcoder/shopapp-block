	...
	register_block_type(
		...
		array(
			...
			'attributes'      => array(
				...
				'benefitOne'          => array( 'type' => 'string', 'default' => __( 'Free 2-day', 'shopapp-blocks' ) ),
				'benefitTwo'          => array( 'type' => 'string', 'default' => __( '60-day returns', 'shopapp-blocks' ) ),
				'benefitThree'        => array( 'type' => 'string', 'default' => __( '2-yr warranty', 'shopapp-blocks' ) ),
				'benefits'            => array( 'type' => 'array', 'default' => array() ),
				'benefitAlignment'    => array( 'type' => 'string', 'default' => 'center' ),
				'benefitBackground'   => array( 'type' => 'string', 'default' => '' ),
				'benefitColor'        => array( 'type' => 'string', 'default' => '' ),
				'benefitIconColor'    => array( 'type' => 'string', 'default' => '' ),
				'benefitBorderRadius' => array( 'type' => 'number', 'default' => 22 ),
				'cardRadius'     => array( 'type' => 'number', 'default' => 34 ),
				'sheetWidth'     => array( 'type' => 'number', 'default' => 640 ),
				'sheetHeight'    => array( 'type' => 'number', 'default' => 900 ),
				'sheetOffsetX'   => array( 'type' => 'number', 'default' => 0 ),
				'sheetOffsetY'   => array( 'type' => 'number', 'default' => 0 ),
