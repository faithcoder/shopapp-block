	...
	register_block_type(
		...
		array(
			...
			'attributes'      => array(
				...
				'benefitOne'          => array( 'type' => 'string', 'default' => __( 'Fast Shipping', 'shopapp-blocks' ) ),
				'benefitTwo'          => array( 'type' => 'string', 'default' => __( 'Fresh Products', 'shopapp-blocks' ) ),
				'benefitThree'        => array( 'type' => 'string', 'default' => __( 'Safe Food', 'shopapp-blocks' ) ),
